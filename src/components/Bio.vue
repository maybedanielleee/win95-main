    ...
    >
      ...
      >
        <div
          ...
          "
        >
          <img class="icon-image" src="../assets/win95Icons/bio.png" />About Me
        </div>
      ...
      <div class="content">
        ...
        >
          ...
          <div class="header">Danielle Chaffin</div>
          <div class="subtitle">
            Solutions Engineer at Revenova | 3rd Generation in Logistics | Occasional Pot Stirrer 
          </div>
          <div class="subtitle">Tennessee 📍</div>
          <div class="badge-grid">
            <img
              class="badge"
              alt="Salesforce Certified Administrator & App Builder"
          ...
          <div class="inner-content">
            <div class="heading"><b>More about me</b></div>
            <div class="paragraph">
              Hello. Hi. Welcome! Danielle comes from a family that has been in trucking for three
              generations. She loves thinking ahead and finding new, creative
              ideas. Danielle really wants to help people do well. She's good at
              solving tricky problems and making things better with her clever
              ideas. Plus, Danielle knows all about using Salesforce to make
              businesses work better. She's always learning more to keep things
              moving forward!
              <br>
              Yes, Danielle wrote this in third-person.
            </div>
            <div class="paragraph">
              Check out my YouTube channel.
              <a
                style="color: #ff5733"
                href="https://www.youtube.com/@maybedanielleee"
                >here</a
              >!
            </div>
          </div>
